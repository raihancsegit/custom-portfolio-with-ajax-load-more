...
;(function ($) {
    $(document).ready(function () {
        ...
        var image_url = $("#book_image_url").val();
        if (image_url) {
            $("#image-container").html(`<img src='${image_url}' />`);
        }

        var images_url = $("#book_images_url").val();
        ...
        $("#upload_image").on("click", function () {
            ...
            frame.on('select', function () {
                ...
                $("#book_image_id").val(attachment.id);
                $("#book_image_url").val(attachment.sizes.thumbnail.url);
        ...
        $("#upload_images").on("click", function () {
            ...
            gframe.on('select', function () {
                ...
                $("#book_images_id").val(image_ids.join(";"));
                $("#book_images_url").val(image_urls.join(";"));
